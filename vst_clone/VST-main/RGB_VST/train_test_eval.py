...
if __name__ == "__main__":
    bulk_data_root = 'D:\\CMPT_489_Bulk\\Data\\'
    ...
    parser.add_argument('--data_root', default=bulk_data_root, type=str, help='data path')
    ...
    parser.add_argument('--trainset', default='train\\', type=str, help='Trainging set')
    ...
    parser.add_argument('--test_paths', type=str, default='val\\')
